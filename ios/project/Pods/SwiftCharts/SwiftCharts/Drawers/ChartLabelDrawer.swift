...
open class ChartLabelSettings {
    ...
    public init(font: UIFont = UIFont.systemFont(ofSize: 14), fontColor: UIColor = UIColor.black, rotation: CGFloat = 0, rotationKeep: ChartLabelDrawerRotationKeep = .center, shiftXOnRotation: Bool = true) {
        self.font = font
...
open class ChartLabelDrawer: ChartContextDrawer {
    ...
    fileprivate let screenLoc: CGPoint
