...
open class ChartGuideLinesLayerAbstract<T: ChartGuideLinesLayerSettings>: ChartCoordsSpaceLayer {
    ...
    fileprivate func drawGuideline(_ context: CGContextRef, p1: CGPoint, p2: CGPoint) {
        fatalError("override")
    }
...
open class ChartGuideLinesLayer_<N>: ChartGuideLinesLayerAbstract<ChartGuideLinesLayerSettings> {
    ...
    override fileprivate func drawGuideline(_ context: CGContextRef, p1: CGPoint, p2: CGPoint) {
...
open class ChartGuideLinesForValuesLayerAbstract<T: ChartGuideLinesLayerSettings>: ChartCoordsSpaceLayer {
    ...
    fileprivate func drawGuideline(_ context: CGContextRef, color: UIColor, width: CGFloat, p1: CGPoint, p2: CGPoint, dotWidth: CGFloat, dotSpacing: CGFloat) {
