...
//        case CourseWeekend = "weekendcourse"
     ...
     */
    func getAuthHeader(_ token: String) -> [String:String] {
     ...
     */
    func post(_ URL:String, parameters: [String: AnyObject]?, token:String? = nil, 
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    - Parameters:
        ...
        - successCallback: callback function if request succeeded
    */
    func get(_ URL:String, token: String? = nil,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    */
    func loginUser(_ action: RESTAction, credentials: [String:String],
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    /**
     ...
     -parameters:
        ...
        - successCallback: callback function if request succeeded
     */
    func registerUser(_ action: RESTAction, credentials: [String:String],
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
     ...
     */
    func updateUser(_ action: RESTAction, token:String, parameters: [String: AnyObject]?, email: String? = nil,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
        var URL = ""
    ...
    func getUserData(_ action: RESTAction, token:String, email: String,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    func getUserAllCourses(_ action: RESTAction, token:String, email: String,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    func getCourses(_ token: String,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    func getCourseType(_ courseKey: String, token: String, successCallback: (_ response: Response<AnyObject, NSError>) -> Void) {
    ...
    func getCourseData(_ courseType: String, courseKey: String, token: String, successCallback: (_ response: Response<AnyObject, NSError>) -> Void) {
    ...
    func getCourse(_ key: String, token: String,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
        ...
        self.getCourseType(key, token: token) { (response) -> Void in
            ...
            if let res = response.response {
                ...
                case 200:
                    ...
                    let type = json["courseType"].stringValue.lowercased()
    ...
    func updateCourse(_ action: RESTAction, token:String, isWeekend: Bool, courseData: [String: AnyObject],
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
        var URL = ""
    ...
    func getClassrooms(_ failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    func uploadVoiceSample(_ fileURL: URL, token: String, fileName: String,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    func authVoiceSample(_ fileURL: URL, token: String, courseKey: String, fileName: String,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
    ...
    func updateManualAttendance(_ email: String, courseKey: String, dateTime: String,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
        guard let token = UserManager.sharedInstance.info.token else {
    ...
    // MARK: - Report
    func getUserReport(_ courseKey: String, email: String,
        failureCallback: ((_ response: Response<AnyObject, NSError>) -> Void)? = nil,
        successCallback: (_ response: Response<AnyObject, NSError>) -> Void)
    {
        // result from server
